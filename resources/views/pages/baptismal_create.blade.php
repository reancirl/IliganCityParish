    ...
    <div class="row">
      <div class="col">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="place_of_baptism" name="place_of_baptism" placeholder="Place of Baptismal" required autocomplete="off" value="{{ old('place_of_baptism') }}">
        </div>
      </div>
